		...
		<div class="list">
			...
			<ul class="items">
				...
				<li>
					...
					<?php if(!$item['done']): ?> 
						<a class="done-button" href="mark4.php?as=done&item=<?php echo $item['ID']; ?>">Mark as done</a>
					<?php else: ?>
						<a class="undone-button" href="mark4.php?as=undone&item=<?php echo $item['ID']; ?>">Mark as undone</a>						
					<?php endif; ?>
				</li>
				<?php endforeach; ?>
			</ul>
